...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "spacy_preprocessing_cython.spacy_tokenize",
        "sources": [
            "spacy_tokenize.pyx"
        ]
    },
    "module_name": "spacy_preprocessing_cython.spacy_tokenize"
}
END: Cython Metadata */
...
#define __PYX_HAVE__spacy_preprocessing_cython__spacy_tokenize
#define __PYX_HAVE_API__spacy_preprocessing_cython__spacy_tokenize
/* Early includes */
#include <string.h>
#include <stdint.h>
#include "ios"
...
/* Module declarations from 'spacy_preprocessing_cython.spacy_tokenize' */
static PyObject *__pyx_f_26spacy_preprocessing_cython_14spacy_tokenize_spacy_tokenize(PyObject *, int __pyx_skip_dispatch); /*proto*/
#define __Pyx_MODULE_NAME "spacy_preprocessing_cython.spacy_tokenize"
extern int __pyx_module_is_main_spacy_preprocessing_cython__spacy_tokenize;
int __pyx_module_is_main_spacy_preprocessing_cython__spacy_tokenize = 0;

/* Implementation of 'spacy_preprocessing_cython.spacy_tokenize' */
...
static PyObject *__pyx_pf_26spacy_preprocessing_cython_14spacy_tokenize_spacy_tokenize(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_sentences); /* proto */
/* Late includes */

/* "spacy_preprocessing_cython/spacy_tokenize.pyx":35
 * # Define function
 * # =============================================================================
 * cpdef spacy_tokenize(list sentences):             # <<<<<<<<<<<<<<
 *     '''
 *     This function takes a list of trings and returns a list of
 */

static PyObject *__pyx_pw_26spacy_preprocessing_cython_14spacy_tokenize_1spacy_tokenize(PyObject *__pyx_self, PyObject *__pyx_v_sentences); /*proto*/
static PyObject *__pyx_f_26spacy_preprocessing_cython_14spacy_tokenize_spacy_tokenize(PyObject *__pyx_v_sentences, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("spacy_tokenize", 0);

  /* "spacy_preprocessing_cython/spacy_tokenize.pyx":51
 *     '''
 *     cdef str i
 *     for i in sentences:             # <<<<<<<<<<<<<<
 *         print(i)
 ...
 */
  ...
  for (;;) {
    ...
    /* "spacy_preprocessing_cython/spacy_tokenize.pyx":52
 *     cdef str i
 *     for i in sentences:
 *         print(i)             # <<<<<<<<<<<<<<
 * 
 */
    __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_builtin_print, __pyx_v_i); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 52, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  ...
  __Pyx_AddTraceback("spacy_preprocessing_cython.spacy_tokenize.spacy_tokenize", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_26spacy_preprocessing_cython_14spacy_tokenize_1spacy_tokenize(PyObject *__pyx_self, PyObject *__pyx_v_sentences); /*proto*/
static char __pyx_doc_26spacy_preprocessing_cython_14spacy_tokenize_spacy_tokenize[] = "\n    This function takes a list of trings and returns a list of \n    tokenized sentences as a list.\n    \n    Parameters\n    ----------\n    sentences : list[str]\n        List of strings that we want to tokenize\n\n    Returns\n    -------\n    None.\n\n    ";
static PyObject *__pyx_pw_26spacy_preprocessing_cython_14spacy_tokenize_1spacy_tokenize(PyObject *__pyx_self, PyObject *__pyx_v_sentences) {
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("spacy_tokenize (wrapper)", 0);
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_sentences), (&PyList_Type), 1, "sentences", 1))) __PYX_ERR(0, 35, __pyx_L1_error)
  __pyx_r = __pyx_pf_26spacy_preprocessing_cython_14spacy_tokenize_spacy_tokenize(__pyx_self, ((PyObject*)__pyx_v_sentences));
...
static PyObject *__pyx_pf_26spacy_preprocessing_cython_14spacy_tokenize_spacy_tokenize(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_sentences) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __pyx_t_1 = __pyx_f_26spacy_preprocessing_cython_14spacy_tokenize_spacy_tokenize(__pyx_v_sentences, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 35, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"spacy_tokenize", (PyCFunction)__pyx_pw_26spacy_preprocessing_cython_14spacy_tokenize_1spacy_tokenize, METH_O, __pyx_doc_26spacy_preprocessing_cython_14spacy_tokenize_spacy_tokenize},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_spacy_preprocessing_cython__spacy_tokenize) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "spacy_preprocessing_cython.spacy_tokenize")) {
      if (unlikely(PyDict_SetItemString(modules, "spacy_preprocessing_cython.spacy_tokenize", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "spacy_preprocessing_cython/spacy_tokenize.pyx":1
 * #!/usr/bin/env python3             # <<<<<<<<<<<<<<
 * # -*- coding: utf-8 -*-
 * """
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init spacy_preprocessing_cython.spacy_tokenize", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init spacy_preprocessing_cython.spacy_tokenize");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
